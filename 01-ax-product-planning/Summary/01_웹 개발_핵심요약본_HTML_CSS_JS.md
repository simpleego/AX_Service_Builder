# 웹 개발 핵심 요약 — HTML · CSS · JavaScript

- **대상** : 풀스택 웹개발을 처음 배우는 입문자  
- **목표** : AI 도구를 활용하더라도 반드시 이해하고 있어야 하는 웹개발의 핵심 개념 정리  
- **활용법** : AI가 생성한 코드를 "읽고, 판단하고, 수정"할 수 있는 최소한의 기초 체력을 기르는 것이 목적
...
<img width="511" height="685" alt="image" src="https://github.com/user-attachments/assets/222e806f-4942-4e07-9d11-b8ca55fd5038" />
