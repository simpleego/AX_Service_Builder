...
> **목표**: ① CSS 배치 기술이 왜, 어떻게 발전해왔는지 흐름을 이해하고 ② Flexbox와 Grid를 상황에 맞게 선택할 수 있는 판단력을 기른다.
> **왜 역사를 배우나?**: 실무 코드와 AI가 생성한 코드에는 옛날 방식과 현대 방식이 섞여 있습니다. "이건 옛날 방식이니 이렇게 고치자"라고 판단하려면 발전 과정을 알아야 합니다.
